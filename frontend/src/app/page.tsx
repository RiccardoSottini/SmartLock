...
export default function Home() {
  ...
  return (
    <NextUIProvider>
      <Header />
      <div
        className="ml-5 mr-5 my-3 text-center"
      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            <div className="mt-1 mb-2" style={{ fontSize: "20px" }}>
              Address: {wallet.account}
            </div>
            <div className="mt-1 mb-2" style={{ fontSize: "20px" }}>
              Balance: {wallet.balance} Polygon (MATIC)
            </div>
            {role == Role.GUEST ? (
              <GuestProvider>
                <Guest />
          ...
          <p
            ...
            style={{ fontSize: "18px" }}
          >
            Connect the Wallet to use the service.
          </p>
        )}
      </div>
    </NextUIProvider>
